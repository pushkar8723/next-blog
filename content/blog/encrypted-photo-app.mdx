...
<p align="center">
  <img
    src="/optimized-images/blogs/encrypted-photo-app/software-estimation-meme.jpg"
    alt="Estimations"
    width="400"
    style="aspect-ratio: 40/37;"
    fetchpriority="high"
  />
</p>
...
const CryptoWorker = Comlink.wrap(new Worker('worker.js', { type: 'module' }));
...
<p align="center">
  <img
    src="/optimized-images/blogs/encrypted-photo-app/skill-issue.jpeg"
    alt="Low Confidence"
    width="480"
    style="aspect-ratio: 16/23;"
  />
</p>
...
<p align="center">
  <img
    src="/optimized-images/blogs/encrypted-photo-app/eureka.jpg"
