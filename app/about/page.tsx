        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
            ...
            <div className="prose max-w-none space-y-6 text-muted-foreground">
                <p className="text-lg leading-relaxed">
                    Hi, I&apos;m {siteConfig.name}. I&apos;m a developer
                    passionate about building great software and sharing what I
                    learn along the way.
                </p>

                <p className="leading-relaxed">
                    I specialize in web development with a focus on React,
                    Next.js, and TypeScript. I believe in writing clean,
                ...
                <p className="leading-relaxed">
                    ...
                    . I&apos;m always happy to chat about web development, open
                    source, or potential collaborations.
                </p>
            </div>
        </div>
    );
